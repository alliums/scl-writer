...
print("Separate them with ! like: 'name ! description ! scale' ")
print("Use interval ratios in fractional form or decimal form(cents).")
print("1 octave = 2/1 = 1200.0000")
print("Do not include the tonic note (1/1).")
